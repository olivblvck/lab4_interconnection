...
| 9 - FullOutbreakThenStop | (0.25, 0.08, 600) | Type (ii) - stops (I→0) with small leftover S>0. <br><img src="readme_files/epidemic_vonNeumann_preset9.png">                      | Type (ii) - stops (I→0) with very small leftover S>0 (near 0 on the plot scale). <br><img src="readme_files/epidemic_moore_preset9.png"> |
